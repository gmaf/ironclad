...
#pragma warning disable SA1025
            ...
            var optionDoNotSendEmail =        app.Option("-s|--no-email", "Does not sends a registration email",                                                       CommandOptionType.NoValue);
            ...
            app.OnExecute(
                () =>
                {
                    ...
                    var user = new User
                    {
                        ...
                        SendConfirmationEmail = !optionDoNotSendEmail.HasValue()
                    };
